                    ...
                    <div class="pull-right" id="navigation-box">
                        ...
                        <ul id="navigation">
                            <li<#if menu_active! == "framework" || menu_active! == "mantle" || menu_active! == "applications" || menu_active! == "addons"> class="active-item"</#if>>
                                ...
                                <ul>
                                    <li<#if menu_active! == "framework"> class="active-item"</#if>><a href="/framework.html">work</a></li>
                                    ...
                                    <!-- test add dropdown item below "Friend" -->
                                    <li<#if menu_active! == "mantle"> class="active-item"</#if>><a href="/moqui-chile/entity/CurrencyEntities.xml">Currency</a></li>
                                </ul>
                            </li>
